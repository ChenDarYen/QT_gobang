...
TestBoard::TestBoard(int owner) : BoardBase(),
                                    _owner(owner),
                                    _position_h(361, 0) {}

TestBoard::TestBoard(int owner, const BoardBase &simple) :
  BoardBase(),
  _owner(owner),
  _position_h(361, 0)
{
...
bool TestBoard::occupy(int player, Coord coord)
{
  if(!BoardBase::occupy(player, coord))
    return false;
...
void TestBoard::remove(Coord coord)
{
...
void TestBoard::_update_position_h(Coord coord)
{
...
void TestBoard::_update_position_h_dir(Coord coord, Direction dir)
{
...
int TestBoard::_coord_heuristic(Coord coord) const
{
...
int TestBoard::_coord_heuristic_dir(Coord coord, Direction dir) const
{
  // consider both block and connect chesses
  return _critical(coord, dir, false) + _critical(coord, dir, true);
}

int TestBoard::_critical(Coord coord, Direction dir, bool connec) const
{
...
int TestBoard::_shape_h(int shape) const
{
  switch(shape)
  {
